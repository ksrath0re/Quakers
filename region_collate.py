...
for root, dirs, files in os.walk(dir):
    ...
    if dirs and dirs[0] == 'CB-Results' and root.split('\\')[-1:][0] in r:
        ...
        if plant_name in region_1:
            ...
            region_2_data.append(returnDataFrame(root, plant_name))
            #print("Plant Name for Region 2: ", plant_name)
        elif plant_name in region_3:
            region_3_data.append(returnDataFrame(root, plant_name))
            #print("Plant Name for Region 3: ", plant_name)
        else:
            region_4_data.append(returnDataFrame(root, plant_name))
...
region_1_file.to_csv(os.path.join(dir, "region_1.csv"))
region_2_file.to_csv(os.path.join(dir, "region_2.csv"))
region_3_file.to_csv(os.path.join(dir, "region_3.csv"))
region_4_file.to_csv(os.path.join(dir, "region_4.csv"))
